...
namespace TemplateManager.AboutView
{
    internal class ApplicationInformation
    {
        ...
        public string FileVersion
        {
            get
            {
                return GetCustomAttribute<AssemblyFileVersionAttribute>(i => i.Version);
            }
        }
        ...
        public string AssemblyConfiguration
        {
            get
            {
                return GetCustomAttribute<AssemblyConfigurationAttribute>(i => i.Configuration);
            }
        }
        ...
        public string AssemblyDescription
        {
            get
            {
                return GetCustomAttribute<AssemblyDescriptionAttribute>(i => i.Description);
            }
        }
        ...
        public string AssemblyProduct
        {
            get
            {
                return GetCustomAttribute<AssemblyProductAttribute>(i => i.Product);
            }
        }
        ...
        public string AssemblyCopyright
        {
            get
            {
                return GetCustomAttribute<AssemblyCopyrightAttribute>(i => i.Copyright);
            }
        }
        ...
        public string AssemblyCompany
        {
            get
            {
                return GetCustomAttribute<AssemblyCompanyAttribute>(i => i.Company);
            }
        }
